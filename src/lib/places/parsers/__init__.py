...
from places.core.types import AbstractClass, Map
from places.databases.entities import DatabaseData
...
class Parser(AbstractClass):
    ...
    def __init__(self, base):
        ...
        Arguments:
            base (places.databases.Database): A database instance to parse
        '''
        self._base = base
    ...
    def __call__(self, **options):
        ...
        Returns:
            places.databases.DatabaseData: The parsed database data
    ...
    def _bindNames(self, row):
        ...
        Arguments:
            row (places.databases.entities.DatabaseRow): The database row to bind
        '''
